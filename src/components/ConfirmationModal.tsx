                  ...
                  {step === 1 ? (
                    <div>
                      <p>
                        ...
                        <span className="font-bold">{formatCurrency(amount)}</span> (10% от суммы
                        вклада) в фонд <span className="font-bold">{fundName}</span>.
                      </p>
                    ...
                    <div>
                      <p className="font-semibold text-red-600 dark:text-red-400">Внимание!</p>
                      <p>
